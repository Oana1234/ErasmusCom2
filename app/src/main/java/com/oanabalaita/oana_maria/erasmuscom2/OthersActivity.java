...
public class OthersActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("tips_others");
        ...
        FirebaseRecyclerAdapter mAdapter = new FirebaseRecyclerAdapter<Tip, OthersActivity.TipHolder>(
                Tip.class,
                R.layout.item_money_general,
                OthersActivity.TipHolder.class,
                reference) {



            @Override
            protected void populateViewHolder(final OthersActivity.TipHolder viewHolder, final Tip tipmodel, int position) {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.add_tip:
                ...
                dialogBuilder.setPositiveButton("DONE", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        final DatabaseReference newRef = mDatabase.child("tips_others").push();
                        ...
                        Toast.makeText(OthersActivity.this,"Thank you for your contribution!", Toast.LENGTH_SHORT).show();
            ...
            case R.id.buttonChooseCity:
                Toast.makeText(OthersActivity.this, "AVAILABLE IN VERSION 2.0. COMMING SOON!",Toast.LENGTH_LONG).show();
