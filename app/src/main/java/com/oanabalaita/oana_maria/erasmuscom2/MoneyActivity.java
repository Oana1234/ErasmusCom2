...
public class MoneyActivity extends AppCompatActivity implements View.OnClickListener{
   ...
   // private static int nrTipsMoneyGeneral = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("tips_money");
        ...
        FirebaseRecyclerAdapter mAdapter = new FirebaseRecyclerAdapter<Tip, MoneyActivity.TipHolder>(
                Tip.class,
                R.layout.item_money_general,
                MoneyActivity.TipHolder.class,
                reference) {



            @Override
            protected void populateViewHolder(final MoneyActivity.TipHolder viewHolder, final Tip tipmodel, int position) {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.add_tip:
                ...
                dialogBuilder.setPositiveButton("DONE", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        final DatabaseReference newRef = mDatabase.child("tips_money").push();
                      ...
                      //  nrTipsMoneyGeneral++;
                        ...
                        currentUser.addValueEventListener(new ValueEventListener() {
                          ...
                          Toast.makeText(MoneyActivity.this,"Thank you for your contribution!", Toast.LENGTH_SHORT).show();
            ...
            case R.id.buttonChooseCity:
                Toast.makeText(MoneyActivity.this, "AVAILABLE IN VERSION 2.0. COMMING SOON!",Toast.LENGTH_LONG).show();
