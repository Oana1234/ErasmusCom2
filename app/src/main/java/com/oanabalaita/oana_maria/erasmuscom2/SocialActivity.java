...
public class SocialActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("tips_social");
        ...
        FirebaseRecyclerAdapter mAdapter = new FirebaseRecyclerAdapter<Tip, SocialActivity.TipHolder>(
                Tip.class,
                R.layout.item_money_general,
                SocialActivity.TipHolder.class,
                reference) {



            @Override
            protected void populateViewHolder(final SocialActivity.TipHolder viewHolder, final Tip tipmodel, int position) {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.add_tip:
                ...
                dialogBuilder.setPositiveButton("DONE", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        final DatabaseReference newRef = mDatabase.child("tips_social").push();
                        ...
                        Toast.makeText(SocialActivity.this,"Thank you for your contribution!", Toast.LENGTH_SHORT).show();
            ...
            case R.id.buttonChooseCity:
                Toast.makeText(SocialActivity.this, "AVAILABLE IN VERSION 2.0. COMMING SOON!",Toast.LENGTH_LONG).show();
